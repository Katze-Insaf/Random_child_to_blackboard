...
while True:
    ...
    if cv2.waitKey(1) == 27:
        ...
        GettingBrawler(face_image, random.choices(phrases)[0],"C:/Users/Katze/PycharmProjects/Random_child_to_blackboard/videos/ElementaryOddFlickertailsquirrel-size_restricted.gif",
